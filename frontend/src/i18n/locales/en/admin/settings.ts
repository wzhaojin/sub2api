export default {
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for iLLMHub end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for iLLMHub end-user login',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on iLLMHub orders; the upstream type is sent as EasyPay type.',
